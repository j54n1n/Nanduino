...
#define USB_CFG_DPLUS_BIT       1
#else
#error Could not generate USB config for unsupported microcontroller.
#endif
...
/* -------------------------- Device Description --------------------------- */
// TODO: Check VID/PID license. For now use Digistump's settings.
 ...
 */
// TODO: Update name. For now use Digistump's settings.
...
// TODO: Check interrupt table for other microcontrollers.
#if defined(__AVR_ATtiny45__) || defined(__AVR_ATtiny85__) 
